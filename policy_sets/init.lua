...
policy_set.policies = {
	...
	require("policy_sets.leaderboard.inputmode"),
	require("policy_sets.leaderboard.inputmodes"),
	...
	require("policy_sets.community.inputmode"),
	require("policy_sets.community.inputmodes"),
